  ...
  <div class="main-content">
    <div v-if="loggedIn">
      ...
      <div class="main-content__body">
        <b-card>
          <router-link to="/master/kategori/tambah">
            <b-button variant="primary">Tambah Kategori</b-button>
          </router-link>
          <hr>
          <v-client-table :data="tableData" :columns="columns" :options="options">
            <div slot="__actions" slot-scope="props">
              <router-link :to="`/master/kategori/edit/${props.row.urlEdit}`">
                <b-button variant="outline-success" size="sm">Edit</b-button>
              </router-link>
              <router-link :to="`/master/kategori/delete/${props.row.urlEdit}`">
